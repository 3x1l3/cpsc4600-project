...
\begin{DoxyCompactList}\small\item\em This is the main administrator class that manages the different compiler functions. \end{DoxyCompactList}\end{DoxyCompactItemize}
\subsection*{Defines}
\begin{DoxyCompactItemize}
\item 
\#define \hyperlink{admin_8h_abfea00ff3da8375f9fdd7a6608632e42}{MAXERRORS}~10
\begin{DoxyCompactList}\small\item\em Standard headers used by the Administrator. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
\subsubsection[{MAXERRORS}]{\setlength{\rightskip}{0pt plus 5cm}\#define MAXERRORS~10}}
