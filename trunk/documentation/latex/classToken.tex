...
The \hyperlink{classToken}{Token} is the Strong/multivalued base type that is used by our \hyperlink{classScanner}{Scanner}, Parser and their communicable Symbol Table.
...
\subsubsection[{Token}]{\setlength{\rightskip}{0pt plus 5cm}Token::Token (
\begin{DoxyParamCaption}
\item[{{\bf Type}}]{newType, }
\item[{int}]{newValue, }
\item[{string}]{newLexeme}
\end{DoxyParamCaption}
)}}
...
{\em newType} & The given Type of token (if known). \\
\hline
{\em newValue} & The value of our lexeme (if any). \\
\hline
{\em newLexeme} & A string representing our Lexeme name. \\
\hline
\end{DoxyParams}
...
\subsubsection[{getLexeme}]{\setlength{\rightskip}{0pt plus 5cm}const string Token::getLexeme (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
) const}}
...
\subsubsection[{getType}]{\setlength{\rightskip}{0pt plus 5cm}const {\bf Type} Token::getType (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
) const}}
...
\subsubsection[{getValue}]{\setlength{\rightskip}{0pt plus 5cm}const int Token::getValue (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
) const}}
...
\begin{DoxyParams}{Parameters}
{\em first} & A token reference that we compare this one to. \\
\hline
\end{DoxyParams}
...
\subsubsection[{setLexeme}]{\setlength{\rightskip}{0pt plus 5cm}void Token::setLexeme (
\begin{DoxyParamCaption}
\item[{string}]{newLexeme}
\end{DoxyParamCaption}
)}}
...
\subsubsection[{setType}]{\setlength{\rightskip}{0pt plus 5cm}void Token::setType (
\begin{DoxyParamCaption}
\item[{{\bf Type}}]{newType}
\end{DoxyParamCaption}
)}}
...
\subsubsection[{setValue}]{\setlength{\rightskip}{0pt plus 5cm}void Token::setValue (
\begin{DoxyParamCaption}
\item[{int}]{newValue}
\end{DoxyParamCaption}
)}}
