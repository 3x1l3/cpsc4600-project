...
\begin{DoxyCompactList}\small\item\em \hyperlink{classToken}{Token} object that is made up of a lexeme (string), a value (integer) and a Type. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
\hyperlink{token_8h_a1d1cfd8ffb84e947f82999c682b666a7aae696377c19e507b64e16be78ce3bbdb}{COMMENT}
 \}
\begin{DoxyCompactList}\small\item\em Enum for our token types. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
\begin{DoxyCompactList}\small\item\em Returns the corresponding string label for a given Type value. \end{DoxyCompactList}\end{DoxyCompactItemize}
\subsection*{Variables}
\begin{DoxyCompactItemize}
\item 
static string \hyperlink{token_8h_a760c2571b6ff185f819314db3d61dbe2}{typeSpelling} \mbox{[}$\,$\mbox{]}
\begin{DoxyCompactList}\small\item\em A string representation of enumerated types, for printing purposes. \end{DoxyCompactList}\end{DoxyCompactItemize}
